...
#run trinity abundance_estimates_to_matrix.pl utility using eXpress as the estimation method.
nice -n19 /usr/local/programs/trinityrnaseq-2.2.0/util/abundance_estimates_to_matrix.pl \
--est_method eXpress \
